...
CREATE TABLE MAIN_ACCOUNTS (
    ...
    AVAILABLE_BALANCE NUMBER(10,2) NOT NULL DEFAULT 0,
...
CREATE INDEX IDX_TXN_EXTERNAL_REF ON MAIN_TRANSACTIONS(EXTERNAL_REF_ID);
...
CREATE TABLE MAIN_OUTBOX_EVENTS (
    ...
    STATUS        VARCHAR2(20) NOT NULL DEFAULT 'PENDING' CHECK (STATUS IN ('PENDING','PUBLISHED','FAILED')),
    CREATED_AT    TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
