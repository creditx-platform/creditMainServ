...
CREATE TABLE CMS_ACCOUNTS (
    ...
    ACCOUNT_TYPE      VARCHAR2(20)     NOT NULL CHECK (ACCOUNT_TYPE IN ('ISSUER','MERCHANT','PLATFORM')),
...
CREATE TABLE CMS_TRANSACTIONS (
    ...
    TYPE           VARCHAR2(50)     NOT NULL CHECK (TYPE IN ('INBOUND','CAPTURE','COMPENSATION','CASHBACK')),
    STATUS         VARCHAR2(50)     NOT NULL CHECK (STATUS IN ('PENDING','AUTHORIZED','SUCCESS','FAILED')),
...
CREATE INDEX IDX_CMS_TXN_ACCOUNT_STATUS ON CMS_TRANSACTIONS(ACCOUNT_ID, STATUS);
